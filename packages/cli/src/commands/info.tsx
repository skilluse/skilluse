...
export const args = z.tuple([z.string().describe("Skill name to show info for")]);
 ...
 */
async function getLocalSkillInfo(skill: InstalledSkill): Promise<SkillInfo | null> {
  try {
        ...
        <Box flexDirection="column">
          ...
          <Box flexDirection="column" marginLeft={2}>
            ...
            <Box>
              ...
              <Text>{info.repo}/{info.repoPath}</Text>
            </Box>
          ...
          {!info.installed && (
            <Box marginTop={1}>
              <Text dimColor>Run 'skilluse install {info.name}' to install this skill.</Text>
            </Box>
          )}
        </Box>
      );
