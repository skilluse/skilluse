...
|----------|-------------|
| `skill` | Skill name from configured repos |
| `github-url` | Full GitHub URL to skill directory |
...
skilluse install https://github.com/owner/repo/tree/main/skills/commit
