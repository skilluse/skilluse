...
Run multiple AI agents on separate issues using Git worktrees.
...
claude --print "Follow task-work workflow. Complete task02-auth per issue.md"
...
2. **Independent issues only** - No dependencies
...
**Good:**
- Well-defined issues with feature.json
...
cd ../my-project-task02
npm test
cat feature.json | jq '.features[] | select(.passes == false)'
